...
#        self.general_vb.setVerticalSpacing(0)
        ...
        buildGridLo.addWidget(QtWidgets.QLabel('Autogenerated GDL file:'), 1, 0, 1, 2) # cols 0-1
        buildGridLo.addWidget(self.build_gdlinc, 1, 2)
        
        # sub-controls for AP generation, enabled or disabled as a unit
        self.build_apctrls = QtWidgets.QWidget(self.build)
        buildGridLo.addWidget(self.build_apctrls, 2, 0, 4, 3)  # 4 rows

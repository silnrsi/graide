...
#        self.general_vb.setVerticalSpacing(0)
        ...
        self.build_ap = FileEntry(self.general, configval(config, 'main', 'ap'), 'AP Files (*.xml)')
        ...
        self.build_invb.addWidget(QtGui.QLabel('AP Database is read only:'), 0, 0, 1, columnSpan = 2) # cols 1-2
        self.build_invb.addWidget(self.build_apronly, 0, 1)
        ...
        self.build_invb.addWidget(self.build_cmd, 1, 1, 1, columnSpan = 2) # cols 1-2
        self.build_inc = FileEntry(self.build_inmake, configval(config, 'build', 'makegdlfile'), 'GDL Files (*.gdl *.gdh)')
        self.build_invb.addWidget(QtGui.QLabel('Autogenerated GDL file:'), 2, 0)
        self.build_invb.addWidget(self.build_inc, 2, 1, 1, columnSpan = 2) # cols 1-2
        self.build_pos = PassSpin(self.build_inmake)
        self.build_invb.addWidget(QtGui.QLabel('Automatic positioning pass:'), 3, 0, 1, columnSpan = 2) # cols 1-2
        self.build_invb.addWidget(self.build_pos, 3, 1)

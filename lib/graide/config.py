...
#        self.general_vb.setVerticalSpacing(0)
        ...
        buildGridLo.addWidget(QtWidgets.QLabel('Autogenerated GDL file:'), 0, 0, 1, 2) # cols 0-1
        ...
        #apGridLo.addWidget(QtWidgets.QLabel('Autogenerated GDL file:'), 2, 0, 1, 2) # cols 0-1
        ...
        tweakGridLo.addWidget(QtWidgets.QLabel('Autogenerated GDL file:'), 0, 0, 1, 2) # cols 0-1

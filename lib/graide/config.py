...
#        self.main_vb.setVerticalSpacing(0)
    ...
    def updateConfig(self, app, config) :
        self.updateChanged(self.main_font, config, 'main', 'font', "ttf", (app.loadFont if app else None))
        self.updateChanged(self.main_gdl, config, 'build', 'gdlfile', "gdl", (app.selectLine if app else None))
        self.updateChanged(self.main_tests, config, 'main', 'testsfile', "xml", (app.loadTests if app else None))

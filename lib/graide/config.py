...
#        self.general_vb.setVerticalSpacing(0)
        ...
        apGridLo.addWidget(self.build_cmd, 0, 2, 1, 3) # cols 1-3
        ...
        apGridLo.addWidget(QtWidgets.QLabel('Attachment point database:'), 1, 0, 1, 2) # cols 0-1
        apGridLo.addWidget(self.build_apxml, 1, 2, 1, 2) # cols 2-3
        ...
        apGridLo.addWidget(QtWidgets.QLabel('AP Database is read-only:'), 2, 0, 1, 2) # cols 0-1
        ...
        apGridLo.addWidget(QtWidgets.QLabel('Attachment positioning pass:'), 3, 0, 1, 2) # cols 0-1
        ...
        buildGridLo.addWidget(QtWidgets.QLabel('Ignore warnings:'), 4, 0)
        buildGridLo.addWidget(self.build_noWarning, 4, 2, 1, 3) # cols 1-3
        ...
        buildGridLo.addWidget(QtWidgets.QLabel('Position tweaker file'), 5, 0, 1, 2) # cols 0-1

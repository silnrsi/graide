...
#        self.general_vb.setVerticalSpacing(0)
        ...
        apGridLo.setColumnMinimumWidth(0, 125) # make this columns in this control match build_twkgrid
        ...
        apGridLo.addWidget(QtGui.QLabel('AP Database is read only:'), 0, 0, 1, columnSpan = 2) # cols 0-1
        apGridLo.addWidget(self.build_apronly, 0, 2)
        ...
        apGridLo.addWidget(QtGui.QLabel('Make GDL Command:'), 1, 0)
        apGridLo.addWidget(self.build_cmd, 1, 2, 1, columnSpan = 3) # cols 1-3

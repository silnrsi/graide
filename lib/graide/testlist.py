...
class TestList(QtGui.QWidget) :
    ...
    def __init__(self, app, fname = None, parent = None) :
        ...
        self.bEdit.setIcon(QtGui.QIcon.fromTheme('document-properties', QtGui.QIcon(":/images/document-properties.png")))
        ...
        self.bAdd.setIcon(QtGui.QIcon.fromTheme('list-add', QtGui.QIcon(":/images/list-add.png")))
        ...
        self.bDel.setIcon(QtGui.QIcon.fromTheme('list-remove', QtGui.QIcon(":/images/list-remove.png")))
